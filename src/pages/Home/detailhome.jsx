        ...
        <div >
            ...
            <div className='mx-3'>
                <div>
                    ...
                    <h1 style={{fontWeight:"bold"}}>LỄ KÍ KẾT HỢP TÁC PHÁT TRIỂN TUYẾN ĐƯỜNG BIỂN MÙA HÈ 2023 VỚI CÁT THIÊMN HẢI TRAVEL</h1>
                </div>
                <div>
                    <p>Ngày 08/07/2023 ,Long Vân Limousine phối hợp cùng với Cát Thiên Hải Travel tiến hành lễ kí hợp tác phát triển tại văn phòng Long 
                        Vân Limousine chi nhánh Bình Thạnh -Sài Gòn.Long Vân Limousine và Cát Thiên Hải Travel ,mỗi bên cử ra 2 đại diện để cùng kí kết 
                        văn bản hợp tác phát triển lần này
                    </p>
                    <p>Nhầm mục tiêu phủ rộng mạng lưới ,đưa thương hiệu vận tải Long Vân Limosine đến gần hơn với khách hàng tại Nha Trang,Mũi Né ,Phan
                        Thiết.Đồng thời ,với mục tiêu phát triển tối đa hệ thống dịch vụ vận tải góp phần nâng cao chất lượng và dịch vụ vận tải ,góp phần 
                        nâng cao chất lựog và dịch vụ cho sự phát triển kinh tế -xã hội cho khu vực và đất nước .Long Vân Limousine và Cát Thiên Hải Travel 
                        thảo luận và đi đến thống nhất liên kết hợp tác trong phát triển dịch vụ vận tải tuyến đường biển .Việc phối hợp cùng Cát Thiên Hải 
                        Travel lần này là quyết tâm và tâm huyết của Long Vân Limousine để sớm hoàn thiện đượuc hệ thống vận tải khắp các tỉnh ,thành phố trên 
                        cả nước ,mang thương hiệu dịch vụ đến gần hơn với khách hàng tại địa phương
                    </p>
                </div>  
            </div>
        </div>
...
export default UseDetailhomePage